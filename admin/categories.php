            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    foreach ($cats as $cat) {
                        ...
                        // Cet Child Categories
                        $childCats = getAllFrom(
                            "*",
                            "categories",
                            "where parent = {$cat['ID']}",
                            "",
                        ...
                        if (!empty($childCats)) {
                            ...
                            foreach ($childCats as $c) {
                                echo "<li class='child-link'>
                                            <a href='categories.php?do=Edit&catid=" . $c['ID'] . "' >
                                                " . $c['Name'] . "
                                            </a>
                                             <a href='categories.php?do=Delete&catid=" . $c['ID'] . "' 
                                                        class='show-delete confirm'>  Delete
                                            </a>
                                    </li>";
                            }
                            echo "</ul>";
...
<?php
            ...
            // If There's No Such ID Show The Error Message
        } else {
            echo "<div class='container'>";
